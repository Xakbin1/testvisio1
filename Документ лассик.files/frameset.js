...
var xmlData = XMLData("Документ лассик.files/data.xml");
...
{
	var strCPHTML = "";
	var strStartTable = "<table class='propViewerTABLE' borderColor='#999999' cellPadding='2' width='95%' border='1' summary='Эта таблица содержит сведения фигур'>";
		strStartTable += "<THEAD class='propViewerTHEAD'><TH>Подпись</TH><TH>Значение</TH></THEAD>";
